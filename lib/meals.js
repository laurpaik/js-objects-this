...
const mealObj = new User('Girl Scout', '2001-12-28', '500');
mealObj.meals.push(new Meal('Samoas', '2017-01-14', 'the best cookie', 130));
mealObj.meals.push(new Meal('Brussel Sprouts', '2017-01-14', 'the best veggie', 40));
mealObj.meals.push(new Meal('Steak', '2017-01-12', 'treat yo self', 680));
mealObj.meals.push(new Meal('Salad', '2017-01-11', 'Caesar', 94));
